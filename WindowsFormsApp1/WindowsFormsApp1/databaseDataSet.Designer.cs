...
namespace WindowsFormsApp1 {
    ...
    public partial class databaseDataSet : global::System.Data.DataSet {
        ...
        public partial class loginDataTable : global::System.Data.TypedTableBase<loginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public loginRow AddloginRow(string Username, string Password, string Job) {
        ...
        public partial class loginRow : global::System.Data.DataRow {
            ...
            public string Job {
                get {
                    try {
                        return ((string)(this[this.tablelogin.JobColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Job\' in table \'login\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablelogin.JobColumn] = value;
                }
            }
            ...
            public bool IsJobNull() {
                return this.IsNull(this.tablelogin.JobColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetJobNull() {
                this[this.tablelogin.JobColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApp1.databaseDataSetTableAdapters {
    ...
    public partial class loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `login` (`Username`, `Password`, `Job`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `login` SET `Username` = ?, `Password` = ?, `Job` = ? WHERE ((`ID` = ?) AN" +
                "D ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password" +
                "` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Job` IS NULL) OR (`Job` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Username, [Password], Job FROM login";
        ...
        public virtual int Delete(int Original_ID, string Original_Username, string Original_Password, string Original_Job) {
        ...
        public virtual int Insert(string Username, string Password, string Job) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, string Job, int Original_ID, string Original_Username, string Original_Password, string Original_Job) {
            if ((Username == null)) {
